...
impl CpuState {
    ...
    pub fn update_CV(&mut self, x: u8, y: u8, res: i16) {
        ...
        self.register.P.V = ((!(x as i16 ^ y as i16) & (x as i16 ^ res) & 0x80) as u16).as_bool();
    }
...
impl NesState {
    ...
    fn _ADC(&mut self, val: u8) {
        let res = self.cpu.register.A as i16 + val as i16 + self.cpu.register.P.C.as_u8() as i16;
